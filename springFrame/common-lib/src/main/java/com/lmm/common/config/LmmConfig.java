...
import com.lmm.common.auth.AuthorizeInterceptor;
import com.lmm.common.auth.FeignRequestHeaderInterceptor;
import com.lmm.common.env.EnvConfig;

import javax.annotation.PostConstruct;
import javax.annotation.PreDestroy;

@Configuration
@EnableConfigurationProperties(LmmProps.class)
public class LmmConfig implements WebMvcConfigurer {
